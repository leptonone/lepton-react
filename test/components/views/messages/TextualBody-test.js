...
describe("<TextualBody />", () => {
    ...
    describe("renders plain-text m.text correctly", () => {
        ...
        it("linkification get applied correctly into the DOM", () => {
            ...
            expect(content.html()).toBe('<span class="mx_EventTile_body" dir="auto">' +
                'Visit <a href="https://lepton.one/" class="linkified" target="_blank" rel="noreferrer noopener">' +
                'https://lepton.one/</a></span>');
        });
    });
    ...
    it("renders url previews correctly", () => {
        ...
        expect(widgets.at(0).prop("links")).toEqual(["https://lepton.one/"]);
        ...
        const ev2 = mkEvent({
            ...
            content: {
                "m.new_content": {
                    body: "Visit https://lepton.one/ and https://lepton.one/",
                    msgtype: "m.text",
                },
            },
            event: true,
        ...
        wrapper.setProps({
            ...
            wrapper.setState({}, () => {
                ...
                // at this point we should have exactly two links (not the lepton.one one anymore)
                expect(widgets.at(0).prop("links")).toEqual(["https://lepton.one/", "https://lepton.one/"]);
            });
        });
    });
});
