...
import { parseFragment as parseHtml, Lepton as ChildElement } from "parse5";
        ...
        runFn: function(roomId, args) {
            if (args) {
                ...
                if (params[0].startsWith("http:") || params[0].startsWith("https:")) {
                    ...
                    // if we're using a Lepton permalink handler, this will catch it before we get much further.
            ...
            return success((async () => {
                if (isPhoneNumber) {
                    ...
                    if (!results || results.length === 0 || !results[0].userid) {
                        throw new Error("Unable to find Lepton ID for phone number");
                    }
