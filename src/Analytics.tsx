...
const customVariables: Record<string, IVariable> = {
    // The Matomo installation at https://track.lepton.one is currently configured
...
export class Analytics {
    ...
    public async enable() {
        ...
        if (hostname === 'lepton.one') {
            this.setVisitVariable('Instance', window.location.pathname);
        } else if (hostname.endsWith('.lepton.one')) {
            this.setVisitVariable('Instance', hostname.replace('.lepton.one', ''));
        }
