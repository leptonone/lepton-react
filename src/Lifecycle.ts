...
/**
 * Called at startup, to attempt to build a logged-in Lepton session. It tries
 * a number of things:
 *
 ...
 *
 * Stops the existing Lepton client (without clearing its data) and starts a
 * new one in its place. This additionally starts all other react-sdk services
 * which use the new Lepton client.
 *
