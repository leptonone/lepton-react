...
const SpacePreview = ({ space, onJoinButtonClicked, onRejectButtonClicked }: ISpacePreviewProps) => {
    ...
    let migratedCommunitySection: JSX.Lepton;
        ...
        <div className="mx_SpaceRoomView_landing_name">
            <RoomName room={space}>
                { (name) => {
                    ...
                    return _t("Welcome to <name/>", {}, tags) as JSX.Lepton;
                } }
            </RoomName>
        </div>
    ...
    return <div className="mx_SpaceRoomView_inviteTeammates">
        ...
        <div className="mx_SpaceRoomView_inviteTeammates_betaDisclaimer">
            ...
            { _t("<b>This is an experimental feature.</b> For now, " +
                ...
                b: sub => <b>{ sub }</b>,
                link: () => <a href="https://one.lepton.one/" rel="noreferrer noopener" target="_blank">
                    one.lepton.one
                </a>,
            }) }
        </div>
