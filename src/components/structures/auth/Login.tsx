...
_td("Homeserver URL does not appear to be a valid Lepton homeserver");
    ...
    onPasswordLogin = async (username, phoneCountry, phoneNumber, password) => {
        ...
        this.loginLogic.loginViaPassword(
                    ...
                    errorText = (
                        <div>
                            ...
                            <div className="mx_Login_smallError">
                                { _t(
                                    'Please note you are logging into the %(hs)s server, not lepton.one.',
            ...
            this.setState({
                ...
                // but the login API gives a 403 https://lepton.one/jira/browse/SYN-744
    ...
    onUsernameBlur = async username => {
        ...
        if (doWellknownLookup) {
            ...
            try {
                ...
                // HS as Lepton's default HS though, there may not be any server change.
