...
export class ContextMenu extends React.PureComponent<IProps, IState> {
    ...
    private onMoveFocus = (element: Lepton, up: boolean) => {
    ...
    private onMoveFocusHomeEnd = (element: Lepton, up: boolean) => {
    ...
    private onKeyDown = (ev: React.KeyboardEvent) => {
        ...
        switch (ev.key) {
            ...
            case Key.ARROW_RIGHT:
                ...
                break;
            case Key.ARROW_UP:
                this.onMoveFocus(ev.target as Lepton, true);
                break;
            case Key.ARROW_DOWN:
                this.onMoveFocus(ev.target as Lepton, false);
                break;
            case Key.HOME:
