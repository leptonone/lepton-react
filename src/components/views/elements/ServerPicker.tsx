...
const onHelpClick = () => {
    Modal.createTrackedDialog('Custom Server Dialog', '', InfoDialog, {
        ...
        description: _t("You can use the custom server options to sign into other Lepton servers by specifying " +
            "a different homeserver URL. This allows you to use Lepton with an existing Lepton account on " +
...
const ServerPicker = ({ title, dialogTitle, serverConfig, onServerConfigChange }: IProps) => {
    ...
    let desc;
    if (serverConfig.hsName === "lepton.one") {
