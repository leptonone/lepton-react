...
export default class Tooltip extends React.Component<IProps> {
    ...
    private tooltip: void | Lepton | Component<Lepton, any, any>;
    private parent: Lepton;
    ...
    public componentDidMount() {
        ...
        this.parent = ReactDOM.findDOMNode(this).parentNode as Lepton;
    ...
    private renderTooltip = () => {
        ...
        this.tooltip = ReactDOM.render<Lepton>(tooltip, this.tooltipContainer);
    };
