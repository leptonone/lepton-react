...
export default class CallEvent extends React.PureComponent<IProps, IState> {
    ...
    private renderCallBackButton(text: string): JSX.Lepton {
        return (
            <AccessibleButton
    ...
    private renderSilenceIcon(): JSX.Lepton {
    ...
    private renderContent(state: CallState | CustomCallState): JSX.Lepton {
