...
export default class MImageBody extends React.Component<IBodyProps, IState> {
    ...
    protected wrapImage(contentUrl: string, children: JSX.Lepton): JSX.Lepton {
    ...
    // Overidden by MStickerBody
    protected getPlaceholder(width: number, height: number): JSX.Lepton {
    ...
    // Overidden by MStickerBody
    protected getTooltip(): JSX.Lepton {
        return null;
    }

    // Overidden by MStickerBody
    protected getFileBody(): string | JSX.Lepton {
