...
export default class TextualBody extends React.Component<IBodyProps, IState> {
    ...
    private applyFormatting(): void {
        ...
        if (this.props.mxEvent.getContent().format === "org.matrix.custom.html") {
            ...
            const pres = (ReactDOM.findDOMNode(this) as Lepton).getElementsByTagName("pre");
            if (pres.length > 0) {
            ...
            // Highlight code
            const codes = (ReactDOM.findDOMNode(this) as Lepton).getElementsByTagName("code");
            if (codes.length > 0) {
    ...
    private activateSpoilers(nodes: ArrayLike<Lepton>): void {
        let node = nodes[0];
        while (node) {
            ...
            if (node.childNodes && node.childNodes.length) {
                this.activateSpoilers(node.childNodes as NodeListOf<Lepton>);
            }
    ...
    private findLinks(nodes: ArrayLike<Lepton>): string[] {
        let links: string[] = [];
    ...
    private isLinkPreviewable(node: Lepton): boolean {
