...
export default class GeneralUserSettingsTab extends React.Component<IProps, IState> {
    ...
    private renderProfileSection(): JSX.Lepton {
        return (
    ...
    private renderAccountSection(): JSX.Lepton {
    ...
    private renderLanguageSection(): JSX.Lepton {
    ...
    private renderSpellCheckSection(): JSX.Lepton {
        return (
            <div className="mx_SettingsTab_section">
    ...
    private renderDiscoverySection(): JSX.Lepton {
    ...
    private renderManagementSection(): JSX.Lepton {
    ...
    private renderIntegrationManagerSection(): JSX.Lepton {
