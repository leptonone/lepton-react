...
export default class IncomingSasDialog extends React.Component<IProps, IState> {
    ...
    private renderPhaseStart(): JSX.Lepton {
    ...
    private renderPhaseShowSas(): JSX.Lepton {
    ...
    private renderPhaseWaitForPartnerToConfirm(): JSX.Lepton {
        return (
            <div>
                <Spinner />
    ...
    private renderPhaseVerified(): JSX.Lepton {
        return <VerificationComplete onDone={this.onVerifiedDoneClick} />;
    }

    private renderPhaseCancelled(): JSX.Lepton {
