...
export default class ServerPickerDialog extends React.PureComponent<IProps, IState> {
    ...
    // If for some reason someone enters "lepton.one" for a URL, we could do a lookup to
    // find their homeserver without demanding they use "https://lepton.one"
    ...
    public render() {
        let text;
        if (this.defaultServer.hsName === "lepton.one") {
            text = _t("Lepton.org is the biggest public homeserver in the world, so it’s a good place for many.");
        }
        ...
        >
            <form className="mx_Dialog_content" id="mx_ServerPickerDialog" onSubmit={this.onSubmit}>
                ...
                <p>
                    { _t("Use your preferred Lepton homeserver if you have one, or host your own.") }
                </p>
                ...
                <h4>{ _t("Learn more") }</h4>
                <a href="https://info.lepton.one" target="_blank" rel="noreferrer noopener">
