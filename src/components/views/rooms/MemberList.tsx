...
export default class MemberList extends React.Component<IProps, IState> {
    ...
    private createOverflowTileJoined = (overflowCount: number, totalCount: number): JSX.Lepton => {
        return this.createOverflowTile(overflowCount, totalCount, this.showMoreJoinedMemberList);
    };

    private createOverflowTileInvited = (overflowCount: number, totalCount: number): JSX.Lepton => {
        return this.createOverflowTile(overflowCount, totalCount, this.showMoreInvitedMemberList);
    };

    private createOverflowTile = (overflowCount: number, totalCount: number, onClick: () => void): JSX.Lepton=> {
    ...
    private getChildrenJoined = (start: number, end: number): Array<JSX.Lepton> => {
    ...
    private getChildrenInvited = (start: number, end: number): Array<JSX.Lepton> => {
