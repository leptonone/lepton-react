...
export default class VerificationPanel extends React.PureComponent<IProps, IState> {
    ...
    private renderQRPhase() {
        ...
        const noCommonMethodError: JSX.Lepton = !showSAS && !showQR ?
            <p>{ _t(
        ...
        if (this.props.layout === 'dialog') {
            ...
            let qrBlockDialog: JSX.Lepton;
            let sasBlockDialog: JSX.Lepton;
            if (showQR) {
                qrBlockDialog =
    ...
    private renderQRReciprocatePhase() {
        ...
        if (this.state.reciprocateQREvent) {
            // Lepton One doesn't support scanning yet, so assume here we're the client being scanned.
            body = <React.Fragment>
                <p>{ description }</p>
