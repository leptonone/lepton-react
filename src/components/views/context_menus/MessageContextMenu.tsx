...
export default class MessageContextMenu extends React.Component<IProps, IState> {
    ...
    render() {
        ...
        let resendReactionsButton: JSX.Lepton;
        let redactButton: JSX.Lepton;
        let forwardButton: JSX.Lepton;
        let pinButton: JSX.Lepton;
        let unhidePreviewButton: JSX.Lepton;
        let externalURLButton: JSX.Lepton;
        let quoteButton: JSX.Lepton;
        let collapseReplyThread: JSX.Lepton;
        let redactItemList: JSX.Lepton;
        ...
        let reportEventButton: JSX.Lepton;
