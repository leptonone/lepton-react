...
function textForPinnedEvent(event: MatrixEvent, allowJSX: boolean): () => string | JSX.Lepton | null {
...
export function textForEvent(ev: MatrixEvent, allowJSX: true, showHiddenEvents?: boolean): string | JSX.Lepton;
export function textForEvent(ev: MatrixEvent, allowJSX = false, showHiddenEvents?: boolean): string | JSX.Lepton {
    const handler = (ev.isState() ? stateHandlers : handlers)[ev.getType()];
