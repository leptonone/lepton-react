...
export const SETTINGS: {[setting: string]: ISetting} = {
    ...
    "promptBeforeInviteUnknownUsers": {
        supportedLevels: LEVELS_ACCOUNT_SETTINGS,
        displayName: _td('Prompt before sending invites to potentially invalid lepton IDs'),
        default: true,
    },
    "showDeveloperTools": {
        supportedLevels: LEVELS_ACCOUNT_SETTINGS,
    ...
    "fallbackICEServerAllowed": {
        supportedLevels: LEVELS_DEVICE_ONLY_SETTINGS,
        displayName: _td(
            "Allow fallback call assist server turn.lepton.one when your homeserver " +
    ...
    "showCommunitiesInsteadOfSpaces": {
        ...
        description: _td("Temporarily show communities instead of Spaces for this session. " +
            "Support for this will be removed in the near future. This will reload Lepton."),
        supportedLevels: LEVELS_DEVICE_ONLY_SETTINGS_WITH_CONFIG,
        default: false,
        controller: new ReloadOnChangeController(),
    },
