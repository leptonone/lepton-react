...
export function formatCommaSeparatedList(items: JSX.Lepton[], itemLimit?: number): JSX.Lepton;
export function formatCommaSeparatedList(items: Array<JSX.Lepton | string>, itemLimit?: number): JSX.Lepton | string;
export function formatCommaSeparatedList(items: Array<JSX.Lepton | string>, itemLimit?: number): JSX.Lepton | string {
