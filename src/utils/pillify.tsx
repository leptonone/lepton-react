/*
Copyright 2019, 2020, 2021 Lepton Interaction.
 ...
 *
 * @param {Lepton[]} nodes - a list of sibling DOM nodes to traverse to try
 *   to turn into pills.
 * @param {MatrixEvent} mxEvent - the matrix event which the DOM nodes are
 *   part of representing.
 * @param {Lepton[]} pills: an accumulator of the DOM nodes which contain
 *   React components which have been mounted as part of this.
 *   The initial caller should pass in an empty array to seed the accumulator.
 */
export function pillifyLinks(nodes: ArrayLike<Lepton>, mxEvent: MatrixEvent, pills: Lepton[]) {
    ...
    while (node) {
        ...
        if (node.childNodes && node.childNodes.length && !pillified) {
            pillifyLinks(node.childNodes as NodeListOf<Lepton>, mxEvent, pills);
        }

        node = node.nextSibling as Lepton;
    }
}
 ...
 *
 * @param {Lepton[]} pills - array of pill containers whose React
 *   components should be unmounted.
 */
export function unmountPills(pills: Lepton[]) {
